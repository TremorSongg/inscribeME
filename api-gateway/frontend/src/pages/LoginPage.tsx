...
const LoginPage = () => {
    return (
        ...
        <div className="flex min-h-[calc(100vh-64px)] w-full items-center justify-center bg-gradient-to-b from-[#90CEF5] to-[#ACD0E6] px-6 py-12 relative overflow-hidden">
